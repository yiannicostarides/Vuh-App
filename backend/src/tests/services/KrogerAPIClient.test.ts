...
describe('KrogerAPIClient', () => {
  ...
  describe('rate limiting', () => {
    it('should enforce rate limits', async () => {
      // This test would require more complex mocking to test the actual rate limiting
      // For now, we'll just verify the rate limit status is tracked
      const initialStatus = krogerClient.getRateLimitStatus();
